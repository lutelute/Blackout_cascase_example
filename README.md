...
電力系統のカスケード停電現象を視覚的に学習できるインタラクティブシミュレーションです。

## 🔗 ライブデモ

**Web版:** https://lutelute.github.io/Blackout_cascase_example/

## 📚 概要

このシミュレーションは、電力系統における発電機や送電線の故障が連鎖的に波及する「カスケード停電」現象を理解するための教育ツールです。
